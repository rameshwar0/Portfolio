...
import { Gamepad2, Code2, Eye, Database, TrendingUp, Wrench, GitBranch } from 'lucide-react';
...
const skillCategories = [
  ...
  { title: 'CI/CD & DevOps', icon: GitBranch, skills: skillsData.ciDevops, color: 'cyan' },
  { title: 'Monetization & Analytics', icon: TrendingUp, skills: skillsData.monetizationAnalytics, color: 'blue' },
  { title: 'Tools & Platforms', icon: Wrench, skills: skillsData.toolsPlatforms, color: 'cyan' },
];
